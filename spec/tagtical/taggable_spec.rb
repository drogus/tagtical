...
describe "Taggable" do
  ...
  it "should be able to create tags" do
    ...
    @taggable.instance_variable_get("@skill_list").instance_of?(Tagtical::TagList).should be_true
    
    lambda {
      @taggable.save
    }.should change(Tagtical::Tag, :count).by(3)
  ...
  describe "grouped_column_names_for method" do
    it "should return all column names joined for Tag GROUP clause" do
      @taggable.grouped_column_names_for(Tagtical::Tag).should == "tags.id, tags.name"
    end
