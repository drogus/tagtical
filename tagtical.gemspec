...
Gem::Specification.new do |s|
  ...
  s.date = "2011-12-18"
  s.description = "Tagtical allows you do create subclasses for Tag and add additional functionality in an STI fashion. For example. You could do Tag::Color.find_by_name('blue').to_rgb. It also supports storing weights or relevance on the taggings."
  s.email = "aryk@mixbook.com"
  s.extra_rdoc_files = [
    "README.rdoc"
  ]
  s.files = [
  ...
  s.homepage = "https://github.com/Mixbook/tagtical"
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.10"
  s.summary = "Tagtical is a tagging plugin for Rails that provides weighting, contexts, and inheritance for tags."
