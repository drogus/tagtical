...
2. Scopes are also created on the Taggable model so you could do Model.colors("red", "blue") and it would return everything tagged with those colors.
...
just the define the subclass and the code will automatically instantiate it as that class. Just do:
