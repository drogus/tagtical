...
5. Add ability to not have multiple taggers for a given tag. In other words, you can specify in a
config file whether a taggable model can have the same tags from multiple different taggers.
6. Support a config/tagtical.yml to further configure the application. For example, since most people
...
Tagtical is not tested to work with Rails < 3.05 and Ruby < 1.9.2

It can probably work with older versions with very little work.
...
== Usage
    ...
    class User < ActiveRecord::Base
      ...
      acts_as_taggable :activities, :interests, :sports # top level :tags is already included.
    end
    module Tag
...
This allows for a wide range of folder structures. You could make a directory called "tag" in your
"app/models" directory and put all these subclasses in there, or you can put it straight in your
"app/models" directory as "color.rb" or "color_tag.rb".
